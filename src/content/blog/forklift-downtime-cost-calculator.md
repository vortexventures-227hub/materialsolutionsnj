...
```text
Downtime cost = lost labor + delayed orders + rental/replacement cost + repair cost + overtime + customer impact
```
...
```text
affected employees x hourly wage x downtime hours
```
...
Sometimes the cost of downtime is not the repair itself - it is the emergency workaround. Rental may make sense for a short outage. Buying used may make sense when an aging truck keeps failing and the need is stable. Review [/inventory](/inventory) if replacement is on the table.
...
```text
Affected labor: 4 people x $30/hour x 6 hours = $720
Overtime: 3 people x $45/hour x 2 hours = $270
Emergency rental: $450/day [example only]
Repair estimate: $1,200
Delayed shipment impact: $500 estimate
...
For high-aisle, narrow-aisle, or safety training questions, also review [/services/osha-training](/services/osha-training) and [/services/wire-guided](/services/wire-guided).
